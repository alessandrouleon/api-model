...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, mongoose_1["default"].connect('mongodb://localhost:27017/service-order')];
                case 1:
                    _a.sent();
                    UserModel = mongoose_1["default"].model('User', user_model_1.UserSchema);
                    users = [
                        {
                            _id: new mongoose_1["default"].Types.ObjectId('69232af427edc653fb85f6e9'),
                            name: 'Administrador',
                            username: 'admin',
